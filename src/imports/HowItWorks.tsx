...
import svgPaths from "./svg-l4hxwssed9";

function Frame16() {
  return (
    <div className="content-stretch flex flex-col font-['Geist:semibold',sans-serif] gap-[4px] items-start relative shrink-0 w-full">
      <p className="leading-[1.5] relative shrink-0 text-[#2952e8] text-[14px] uppercase w-full">How it works</p>
      <p className="leading-[1.3] relative shrink-0 text-[#18181b] text-[44px] tracking-[-2px] w-full">Personal outreach, automated</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start max-w-[600px] not-italic relative shrink-0 w-full whitespace-pre-wrap" data-name="text">
      <Frame16 />
      <p className="font-['Geist:regular',sans-serif] leading-[1.5] relative shrink-0 text-[#70707b] text-[20px] w-full">Go from a single recording to thousands of personalized video emails in four steps.</p>
    </div>
  );
}
...
function Img() {
  return (
    <div className="bg-[#f9f9f9] h-[286px] min-h-[286px] relative shrink-0 w-[492px]" data-name="img">
      <Frame />
    </div>
  );
}
...
function Card() {
  return (
    <div className="content-stretch flex flex-col h-[461px] items-start overflow-clip relative rounded-[16px] shrink-0 w-[492px]" data-name="card">
      <Img />
      <Text1 />
    </div>
  );
...
function Group2() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(50%+153.5px)] top-[61.66px]">
      <Frame5 />
...
function Img1() {
  return (
    <div className="bg-[#f9f9f9] h-[286px] min-h-[286px] overflow-clip relative shrink-0 w-[492px]" data-name="img">
      <Group2 />
    </div>
  );
}
...
function Row() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative" data-name="row">
      <Card />
      <Card1 />
    </div>
  );
...
function Group9() {
  return (
    <div className="-translate-x-1/2 absolute contents left-[calc(50%-1.5px)] top-[48px]">
      <Group17 />
      <Frame8 />
      <Group14 />
    </div>
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-[496px]" data-name="row">
      <Card2 />
      <Card3 />
    </div>
  );
...
function Tiles() {
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="tiles">
      {/* Card 1 */}
      <motion.div 
        className="content-stretch flex flex-col h-[461px] items-start overflow-clip relative rounded-[16px] shrink-0"
        animate={{ width: hoveredCard === 1 ? 492 : 240 }}
        transition={{ 
          type: "spring",
          stiffness: 300,
          damping: 30,
      ...
      {/* Card 2 */}
      <motion.div 
        className="content-stretch flex flex-col items-start overflow-clip relative rounded-[16px] self-stretch"
        animate={{ width: hoveredCard === 2 ? 492 : 240 }}
        transition={{ 
          type: "spring",
          stiffness: 300,
          damping: 30,
      ...
      {/* Card 3 */}
      <motion.div 
        className="bg-[#f9f9f9] content-stretch flex flex-col items-start overflow-clip relative rounded-[16px] self-stretch"
        animate={{ width: hoveredCard === 3 ? 492 : 240 }}
        transition={{ 
          type: "spring",
          stiffness: 300,
          damping: 30,
      ...
      {/* Card 4 */}
      <motion.div 
        className="bg-white content-stretch flex flex-col h-[467px] items-start overflow-clip relative rounded-[16px]"
        animate={{ width: hoveredCard === 4 ? 492 : 240 }}
        transition={{ 
          type: "spring",
          stiffness: 300,
          damping: 30,
...
export default function HowItWorks() {
  return (
    <div className="bg-white content-stretch flex items-start justify-center py-[88px] relative size-full" data-name="How it works">
      <Content />
    </div>
  );
}
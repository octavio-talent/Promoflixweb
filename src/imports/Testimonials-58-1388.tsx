...
function Top() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center max-w-[560px] not-italic relative shrink-0 text-center w-full whitespace-pre-wrap" data-name="top">
      <Frame />
    ...
    <div className="bg-white relative rounded-[16px] shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)] shrink-0 w-full" data-name="Top container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start p-[16px] relative w-full">
        ...
        <div className="flex flex-col font-['Geist:regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18181b] text-[16px] w-full">
          <p className="leading-[1.5] whitespace-pre-wrap">{`"Promoflix helped us personalize email responses at a scale we couldn't have imagined before. Our reply rate tripled in the first week."`}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white relative rounded-[16px] shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)] shrink-0 w-full" data-name="Top container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start p-[16px] relative w-full">
        <Container4 />
        <div className="flex flex-col font-['Geist:regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18181b] text-[16px] w-full">
          <p className="leading-[1.5] whitespace-pre-wrap">{`"Promoflix helped us personalize email responses at a scale we couldn't have imagined before. Our reply rate tripled in the first week."Promoflix helped us personalize email responses at a scale we couldn't have imagined before. Our reply rate tripled in the first week.""`}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white relative rounded-[16px] shadow-[0px_1px_4px_0px_rgba(12,12,13,0.05)] shrink-0 w-full" data-name="Top container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[16px] items-start p-[16px] relative w-full">
        <Container6 />
        <div className="flex flex-col font-['Geist:regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#18181b] text-[16px] w-full">
          <p className="leading-[1.5] whitespace-pre-wrap">{`"Promoflix helped us personalize email responses at a scale we couldn't have imagined before. Our reply rate tripled in the first week. Our reply rate tripled in the first week."`}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-start justify-center relative shrink-0 w-full" data-name="Container">
      ...
      <div className="absolute bottom-0 flex items-center justify-center right-0 top-0 w-[120px]">
        <div className="-scale-y-100 flex-none h-[290px] rotate-180 w-[120px]">

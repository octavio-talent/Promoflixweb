...
function Container() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip pb-[136px] pt-[88px] relative rounded-bl-[120px] rounded-br-[120px] shrink-0 w-[1512px]" data-name="container">
      <ContentGrid />
    </div>
  );
}
